...
public class raveConfig {
    ...
    public static final String SANBOX_URL = "https://ravesandboxapi.flutterwave.com/v2/services/confluence";
    public static final String LIVE_URL = "https://ravesandboxapi.flutterwave.com/v2/services/confluence";
    ...
    public static final String SANDBOX_CHARGE_URL = "https://ravesandboxapi.flutterwave.com/flwv3-pug/getpaidx/api/charge";
    public static final String SANDBOXMOBILEMONEY_CHARGE_URL = "https://ravesandboxapi.flutterwave.com/flwv3-pug/getpaidx/api/charge";
    ...
    public static final String SANDBOX_REFUND_URL = "https://ravesandboxapi.flutterwave.com/gpx/merchant/transactions/refund";
    public static final String LIVE_REFUND_URL = "https://api.ravepay.co/gpx/merchant/transactions/refund";
    public static final String PAYMENT_PLAN_CREATE_SANDBOX_URL = "https://ravesandboxapi.flutterwave.com/v2/gpx/paymentplans/create";
    ...
    public static final String SUSCRIPTION_LIST_SANDBOX_URL = "https://ravesandboxapi.flutterwave.com/v2/gpx/subscriptions/query";
    public static final String SUSCRIPTION_SANDBOX_URL = "https://ravesandboxapi.flutterwave.com/v2/gpx/subscriptions/";
    public static final String SUBACCOUNT_LIST_SANDBOX_URL = "https://ravesandboxapi.flutterwave.com/v2/gpx/subaccounts";
    public static final String VIRTUAL_CARD_CREATE_URL = "https://ravesandboxapi.flutterwave.com/v2/services/virtualcards/";
    public static final String LIVE_VIRTUAL_CARD_CREATE_URL = "https://api.ravepay.co/v2/services/virtualcards/new";
     public static final String VIRTUAL_CARD_FUND_URL = "https://ravesandboxapi.flutterwave.com/v2/services/virtualcards/fund";
    ...
    public static final String TOKEN_UPDATE_URL_SANDBOX = "https://ravesandboxapi.flutterwave.com/v2/gpx/tokens/";
